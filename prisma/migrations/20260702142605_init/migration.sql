-- CreateEnum
CREATE TYPE "ENVIRONMENT_TYPE" AS ENUM ('GLOBAL', 'COLLECTION');
...
CREATE TABLE "Environment" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "type" "ENVIRONMENT_TYPE" NOT NULL DEFAULT 'GLOBAL',
...
-- AddForeignKey
ALTER TABLE "Environment" ADD CONSTRAINT "Environment_collectionId_fkey" FOREIGN KEY ("collectionId") REFERENCES "Collection"("id") ON DELETE CASCADE ON UPDATE CASCADE;
